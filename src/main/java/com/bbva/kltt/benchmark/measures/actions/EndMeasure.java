 ...
 * 
 */
public class EndMeasure implements IAction<Long>
{
	...
	{
		jobContext.getUserMeasures().addEndMeasure(this.measureName, jobContext.getJobIteration(), testContext.getTimeUtil().getTime());
