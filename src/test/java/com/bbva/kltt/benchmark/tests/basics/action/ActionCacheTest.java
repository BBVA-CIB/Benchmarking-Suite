 ...
 *
 */
public class ActionCacheTest implements IAction<Boolean>
{
	private static final Logger LOGGER = LoggerFactory.getLogger(ActionCacheTest.class);
...
//		InitTest initTest = ((InitTest) testContext.getInitializables().get("InitJUnit"));
		...
		CacheActions.getInstance().addEjecution(testContext.getTestName());
